...
public class Note {
    ...
    public Note(String cn_note_id, String cn_notebook_id, String cn_user_id, String cn_note_title, Long cn_note_create_time, Long cn_note_last_modify_time) {
    ...
    public String toString() {
        return "Note{" +
                ...
                ", lcn_note_last_modify_time=" + cn_note_last_modify_time +
                '}';
    }
